 ...
 */
package circularqueue.view.centralpanelcomponents;
...
public class DequePanel extends JPanel{
    ...
    public void initComponents() {
        ...
        this.GBCWarning = new GridBagConstraints();
        this.GBCWarning.gridx=0;
        this.GBCWarning.gridy=3;
        this.GBCWarning.gridwidth=4;
        this.GBCWarning.gridheight=1;
        this.GBCWarning.fill = GridBagConstraints.BOTH;
        this.GBCWarning.ipadx=0;
        this.GBCWarning.ipady=0;
        this.GBCWarning.anchor = GridBagConstraints.CENTER;
        this.add(this.warning, this.GBCWarning);
    ...
    public void setUILook(){
        ...
        this.title.setBorder(new EmptyBorder(20,40,20,40));
        this.title.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 23));
        this.title.setForeground(Color.WHITE);
        this.title.setOpaque(true);
        this.title.setBackground(new Color(32,32,32));
        ...
        this.enqueueButton.setBackground(new Color(160,160,160));
        ...
        this.enqueueButton.setForeground(Color.white);
        
        this.dequeueButton.setBorder(null);
        this.dequeueButton.setBackground(new Color(60,20,20));
        ...
        this.dequeueButton.setForeground(Color.white);
    }
    
    public void showWarning(String state) {
        this.remove(this.warning);
        this.warning = new JLabel("Warning, " + state + " Queue!");
        this.warning.setHorizontalAlignment(SwingConstants.CENTER);
        this.warning.setBorder(new EmptyBorder(20,40,20,40));
        this.warning.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 16));
        this.warning.setForeground(Color.white);
        this.warning.setOpaque(true);
        this.warning.setBackground(new Color(40,5,5));
        this.warning.setPreferredSize(new Dimension(300,40));
        this.add(this.warning, this.GBCWarning);
    }
